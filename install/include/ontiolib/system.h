...
extern "C" {
    ...
    *
    *  @code
    *  ontio_assert(1 == 2, "One is not equal to two.");
    *  ontio_assert(1 == 1, "One is not equal to one.");
    *  @endcode
    *
    ...
    */
   void  ontio_assert_message( uint32_t test, const char* msg, uint32_t msg_len );
    ...
    */
   void  ontio_assert_code( uint32_t test, uint64_t code );
