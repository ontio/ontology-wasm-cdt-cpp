...
/**
  ...
  *  ontio_assert(itr >= 0, "Alice cannot be removed since she was already not found in the table");
  *  db_remove_i64(itr);
  *  @endcode
  */
...
/**
  ...
  *  ontio_assert(len <= 50, "buffer to small to store retrieved record");
...
/**
  ...
  *  ontio_assert(end_itr < -1, "Charlie was not the last entry in the table");
  *  @endcode
  */
