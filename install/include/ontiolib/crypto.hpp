...
namespace ontio {
   ...
   */
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return ontio::checksum256 - Computed digest
    */
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return ontio::checksum160 - Computed digest
    */
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return ontio::checksum512 - Computed digest
    */
    ...
    *  @param sig - Signature
    *  @return ontio::public_key - Recovered public key
    */
